...
// BusinessService proxies business (payer) CRUD, activation, and DBA
// operations to the TaxBandits public API.
...
// NewBusinessService builds a BusinessService that authenticates via
