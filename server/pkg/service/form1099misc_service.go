...
// Form1099MiscService proxies create, get, update, and validation
// operations for Form 1099-MISC to the TaxBandits public API.
...
// NewForm1099MiscService builds a Form1099MiscService that authenticates
