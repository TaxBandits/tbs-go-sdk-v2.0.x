...
// RecipientService proxies recipient (payee) CRUD, activation, business
// assignment, and DBA operations to the TaxBandits public API.
...
// NewRecipientService builds a RecipientService that authenticates via
// authService and calls the TaxBandits API described by cfg. A nil
